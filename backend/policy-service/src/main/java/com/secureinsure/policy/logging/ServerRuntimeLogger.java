package com.secureinsure.policy.logging;
...
public class ServerRuntimeLogger {
    ...
    public void initialize() {
        System.out.println("Policy Service Runtime Logger initialized");
    ...
    private void logSystemInfo() {
        try {
            ...
            System.out.println("Policy Service System Info: " + systemInfo);
    ...
    private void monitorMemory() {
        try {
            ...
            if (heapUsagePercent > 90) {
                System.err.println("CRITICAL: Policy Service memory usage detected: " + heapUsagePercent + "%");
            } else if (heapUsagePercent > 80) {
                System.out.println("WARNING: Policy Service high memory usage detected: " + heapUsagePercent + "%");
            }
            ...
            System.out.println("Policy Service Memory metrics: " + memoryMetrics);
    ...
    private void monitorThreads() {
        try {
            ...
            if (threadCount > 1000) {
                System.out.println("WARNING: Policy Service high thread count detected: " + threadCount);
            }
            
            // Check for deadlocked threads
            long[] deadlockedThreads = threadMXBean.findDeadlockedThreads();
            if (deadlockedThreads != null && deadlockedThreads.length > 0) {
                System.err.println("CRITICAL: Policy Service deadlocked threads detected: " + deadlockedThreads.length);
            }
            ...
            System.out.println("Policy Service Thread metrics: " + threadMetrics);
    ...
    private void monitorClassLoading() {
        try {
            ...
            System.out.println("Policy Service Class loading metrics: " + classMetrics);
    ...
    private void monitorPerformance() {
        try {
            ...
            if (operatingSystemMXBean instanceof com.sun.management.OperatingSystemMXBean) {
                ...
                if (cpuLoad > 0.9) {
                    System.out.println("WARNING: Policy Service high CPU usage detected: " + cpuLoad);
                }
                
                // System load average
                double systemLoadAverage = operatingSystemMXBean.getSystemLoadAverage();
                if (systemLoadAverage > 0.8) {
                    System.out.println("WARNING: Policy Service high system load detected: " + systemLoadAverage);
                }
            }
        ...
        try {
            ...
            if (totalRequestsCount > 0) {
                ...
                if (errorRate > 10) { // More than 10% error rate
                    System.err.println("CRITICAL: Policy Service error rate detected: " + errorRate + "%");
                } else if (errorRate > 5) { // More than 5% error rate
                    System.out.println("WARNING: Policy Service high error rate detected: " + errorRate + "%");
                }
                
                if (warningRate > 20) { // More than 20% warning rate
                    System.out.println("WARNING: Policy Service high warning rate detected: " + warningRate + "%");
                }
            }
    ...
    private void logDetailedSystemMetrics() {
        try {
            ...
            System.out.println("Policy Service Detailed metrics: " + detailedMetrics);
    ...
    public void logRuntimeError(String category, String message, Exception exception, 
        ...
        System.err.println("Policy Service Runtime Error [" + category + "]: " + message + " - " + exception.getMessage());
    }
    
    public void logRuntimeWarning(String category, String message, Map<String, Object> details,
                                 String userId, String sessionId, String requestId, String ipAddress, String userAgent) {
        incrementWarningCount();
        System.out.println("Policy Service Runtime Warning [" + category + "]: " + message + " - " + details);
    }
