...
Locator:  getByTestId('app-details-title')
Expected: visible
...
[2m  - waiting for getByTestId('app-details-title')[22m

    at C:\Users\karuppk\Desktop\Cursor AI\secureinsure-pro\frontend\e2e\simple-application-details.spec.ts:9:57
```
